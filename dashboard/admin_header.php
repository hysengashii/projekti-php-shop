    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown ml-auto">
        ...
        <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="#">User: <span> <b><?php echo $_SESSION['admin_name'];   ?></span></b></a>
          <a class="dropdown-item" href="#">Email: <span><b><?php echo $_SESSION['admin_email'];   ?></span></b> </a>
